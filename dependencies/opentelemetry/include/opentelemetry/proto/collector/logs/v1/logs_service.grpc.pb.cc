...
std::unique_ptr< LogsService::Stub> LogsService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< LogsService::Stub> stub(new LogsService::Stub(channel));
  return stub;
}

LogsService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_Export_(LogsService_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void LogsService::Stub::experimental_async::Export(::grpc::ClientContext* context, const ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest* request, ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse* response, std::function<void(::grpc::Status)> f) {
...
void LogsService::Stub::experimental_async::Export(::grpc::ClientContext* context, const ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest* request, ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
