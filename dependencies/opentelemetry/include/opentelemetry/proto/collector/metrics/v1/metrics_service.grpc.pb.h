 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void Export(::grpc::ClientContext* context, const ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* request, ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void Export(::grpc::ClientContext* context, const ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* request, ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_Export : public BaseClass {
   ...
   public:
    ...
    #endif
                     context, const ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* request, ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* response) { return this->Export(context, request, response); }));}
    void SetMessageAllocatorFor_Export(
        ::grpc::experimental::MessageAllocator< ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest, ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    virtual ::grpc::ServerUnaryReactor* Export(
      ::grpc::CallbackServerContext* /*context*/, const ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* /*request*/, ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* Export(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* /*request*/, ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
