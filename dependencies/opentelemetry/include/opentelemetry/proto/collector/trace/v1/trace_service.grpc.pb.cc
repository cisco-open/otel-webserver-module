...
TraceService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_Export_(TraceService_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void TraceService::Stub::experimental_async::Export(::grpc::ClientContext* context, const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest* request, ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse* response, std::function<void(::grpc::Status)> f) {
...
void TraceService::Stub::experimental_async::Export(::grpc::ClientContext* context, const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest* request, ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
