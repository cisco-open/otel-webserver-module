...
static const command_rec appd_cmds[] =
{
    ...
    AP_INIT_TAKE1(
            "appDynamicsOtelExporterEndpoint",
    ...
    AP_INIT_TAKE1(
            "appDynamicsOtelMaxExportBatchSize",
